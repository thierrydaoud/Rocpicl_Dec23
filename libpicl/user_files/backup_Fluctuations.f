...
!
     ...
     >       A1, A2, A3, A4
      ...
      real*8 phip, phig, alpha_fluid, alpha_par, alpha_perp, alpha(3,3)
!
! Code:
!
      TwoPi = 2.0d0*acos(-1.0d0)
...
!     >*(phig*(-5.11d0*phip+10.1d0*phip**2-10.85d0*phip**3)
!     > +1.0d0-exp(-10.96d0*phip))/
!     >(1.17d0*phip-0.2021d0*phip**(1.0d0/2.0d0)+0.08568*phip**(1.0d0/4.0d0)
!     >*phig**2*(1.0d0-1.6d0*phip*phig-3.0d0*phip*phig**4
!     >*exp(-re**(0.4)*phip)))
!       
!
!       ! Thermal Diffusivity
